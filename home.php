...
<html>
  ...
  <body>
    <header align=center>
      <h1>
        <a href="index.php">ALEXLEE 게시판</a>
      </h1>
    </header>
    <?
      if($_SESSION['userid']){
    ...
    <aside id="left">
      ...
      <ul>
        ...
        <li><a target="iframe1" href="board.php?board_id=board">프로그래밍 게시판</a></li>
 
        <li><a target="iframe1" href="board.php?board_id=music">제품 게시판</a></li>
        <li><a target="iframe1" href="board.php?board_id=movie">DIY 게시판</a></li>
      </ul>
    </aside>
    <section id="main">
      <article id="article1">
    ...
    <footer>Copyright 2022.ALEXLEE.COM.All rights reserved.</footer>
  </body>
</html>